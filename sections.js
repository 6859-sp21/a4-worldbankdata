...
function drawInitial(){
    ...
    .attr('xlink:href', 'https://raw.githubusercontent.com/6859-sp21/a4-worldbankdata/main/plot1.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot2')
    .attr('xlink:href', 'https://raw.githubusercontent.com/6859-sp21/a4-worldbankdata/main/plot2.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot3')
    .attr('xlink:href', 'https://raw.githubusercontent.com/6859-sp21/a4-worldbankdata/main/plot3.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot4')
    .attr('xlink:href', 'https://raw.githubusercontent.com/6859-sp21/a4-worldbankdata/main/plot4.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot5')
    .attr('xlink:href', 'https://raw.githubusercontent.com/6859-sp21/a4-worldbankdata/main/plot5.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot6')
    .attr('xlink:href', 'https://raw.githubusercontent.com/6859-sp21/a4-worldbankdata/main/plot6.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)
}

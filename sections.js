...
function drawInitial(){
    ...
    .attr('xlink:href', 'https://github.com/6859-sp21/a4-worldbankdata/blob/main/nehruModi.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 1)

    svg.append('g').append('image').attr('class', 'plot1')
    .attr('xlink:href', '/Users/geetkalra/Desktop/india growth story uploaded/data/plot1.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot2')
    .attr('xlink:href', '/Users/geetkalra/Desktop/india growth story uploaded/data/plot2.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot3')
    .attr('xlink:href', '/Users/geetkalra/Desktop/india growth story uploaded/data/plot3.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot4')
    .attr('xlink:href', '/Users/geetkalra/Desktop/india growth story uploaded/data/plot4.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot5')
    .attr('xlink:href', '/Users/geetkalra/Desktop/india growth story uploaded/data/plot5.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot6')
    .attr('xlink:href', '/Users/geetkalra/Desktop/india growth story uploaded/data/plot6.png')
    .attr('width', 1000)
    .attr('height', 950)
    .attr('opacity', 0)
}
